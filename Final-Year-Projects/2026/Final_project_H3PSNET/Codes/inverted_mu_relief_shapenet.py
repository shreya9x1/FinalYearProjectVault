...
PRETRAINED_PATH = r"C:\Users\CSE_SDPL\Desktop\ModelNet40-PointNet\best_samnetpp_shapenet.pth"
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for batch in pbar:
            ...
            pred = model(points, dummy_cat) # [B, N, C]
        ...
        if miou > best_miou:
            best_miou = miou
            torch.save(model.state_dict(), 'best_samnetpp_shapenet_relief.pth')
